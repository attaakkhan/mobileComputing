...
def rec(person, dated, remlist=[]):
        ...
        for i in listt:
              ...
              con = sqlite3.connect("/home/atta/eclipse-workspace/mCAssingment2Server/src/main/resources/LifeMap_GS"+str(person)+".db")
              ...
              con.close()
              con = sqlite3.connect("/home/atta/eclipse-workspace/mCAssingment2Server/src/main/resources/LifeMap_GS"+str(i)+".db")
