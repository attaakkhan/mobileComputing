...
public class CovidSymptoms {
  ...
  + ")";
    ...
    public CovidSymptoms(float heartRate, float respiratoryRate,float nausea, float headAch,float diarhea,float soarThroat, float fever, float muscleAche,float lossSmellTaste,float cough,float shortnessBreath,float tired) {
        this.heartRate = heartRate;
        this.respiratoryRate = respiratoryRate;
        this.nausea = nausea;
        this.headAch = headAch;
